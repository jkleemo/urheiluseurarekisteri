 ...
 * @version 2021.04.15 17:34:26 // Generated by ComTest
 *
 */
...
public class JasenTest {
  ...
  /** testGetNimi273 */
  @Test
  public void testGetNimi273() {    // Jasen: 273
    Jasen jasen1 = new Jasen(); 
    jasen1.jasenenTaytto(); 
    { String _l_=jasen1.getNimi(),_r_="Jouko Joukkio"; if ( !_l_.matches(_r_) ) fail("From: Jasen line: 276" + " does not match: ["+ _l_ + "] != [" + _r_ + "]");}; 
  } // Generated by ComTest END
  ...
  /** testGetPostinro288 */
  @Test
  public void testGetPostinro288() {    // Jasen: 288
    Jasen jasen1 = new Jasen(); 
    jasen1.jasenenTaytto(); 
    { String _l_=jasen1.getPostinro(),_r_="14144"; if ( !_l_.matches(_r_) ) fail("From: Jasen line: 291" + " does not match: ["+ _l_ + "] != [" + _r_ + "]");}; 
  } // Generated by ComTest END
}