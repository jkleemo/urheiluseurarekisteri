 ...
 * @version 2021.04.20 21:32:13 // Generated by ComTest
 *
 */
...
public class JasenetTest {
  ...
  public void testTallenna218() throws SailoException {    // Jasenet: 218
    ...
    dir.mkdir(); 
    ftied.delete(); 
    assertEquals("From: Jasenet line: 234", false, ftied.delete()); 
    File fbak = new File(tiedNimi+".bak"); 
    fbak.delete(); 
    assertEquals("From: Jasenet line: 237", false, fbak.delete()); 
    assertEquals("From: Jasenet line: 238", true, dir.delete()); 
  } // Generated by ComTest END


  // Generated by ComTest BEGIN
  /** 
   * testJasenetIterator276 
   * @throws SailoException when error
   */
  @Test
  public void testJasenetIterator276() throws SailoException {    // Jasenet: 276
    Jasenet jasenet = new Jasenet(); 
    ...
    assertEquals("From: Jasenet line: 294", tulos, ids.toString()); 
    ...
    assertEquals("From: Jasenet line: 305", true, i.next() == jouko1); 
    assertEquals("From: Jasenet line: 306", true, i.next() == jouko2); 
    assertEquals("From: Jasenet line: 307", true, i.next() == jouko1); 
    try {
    i.next(); 
    fail("Jasenet: 309 Did not throw NoSuchElementException");
   ...
   */
  @Test
  public void testEtsi363() throws SailoException {    // Jasenet: 363
    Jasenet jasenet = new Jasenet(); 
    ...
    assertEquals("From: Jasenet line: 374", 5, loytyneet.size()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLisaa394() throws SailoException {    // Jasenet: 394
    Jasenet jasenet = new Jasenet(); 
    Jasen eka = new Jasen(); 
    ...
    assertEquals("From: Jasenet line: 408", 0, jasenet.getLkm()); 
    jasenet.lisaa(eka); assertEquals("From: Jasenet line: 409", 1, jasenet.getLkm()); 
    jasenet.lisaa(toka); assertEquals("From: Jasenet line: 410", 2, jasenet.getLkm()); 
    jasenet.lisaa(kolmas); assertEquals("From: Jasenet line: 411", 3, jasenet.getLkm()); 
    jasenet.lisaa(neljas); assertEquals("From: Jasenet line: 412", 4, jasenet.getLkm()); 
    jasenet.lisaa(viides); assertEquals("From: Jasenet line: 413", 5, jasenet.getLkm()); 
    jasenet.lisaa(kuudes); assertEquals("From: Jasenet line: 414", 6, jasenet.getLkm()); 
    jasenet.lisaa(seiska); assertEquals("From: Jasenet line: 415", 7, jasenet.getLkm()); 
    jasenet.lisaa(kasi); assertEquals("From: Jasenet line: 416", 8, jasenet.getLkm()); 
    jasenet.lisaa(ysi); assertEquals("From: Jasenet line: 417", 9, jasenet.getLkm()); 
    jasenet.lisaa(kymppi); assertEquals("From: Jasenet line: 418", 10, jasenet.getLkm()); 
    jasenet.lisaa(ykstoista); assertEquals("From: Jasenet line: 419", 11, jasenet.getLkm()); 
  } // Generated by ComTest END
}