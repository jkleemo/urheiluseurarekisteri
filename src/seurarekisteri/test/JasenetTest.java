 ...
 * @version 2021.04.15 23:25:55 // Generated by ComTest
 *
 */
...
public class JasenetTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testJasenetIterator250 
   * @throws SailoException when error
   */
  @Test
  public void testJasenetIterator250() throws SailoException {    // Jasenet: 250
    Jasenet jasenet = new Jasenet(); 
    ...
    assertEquals("From: Jasenet line: 268", tulos, ids.toString()); 
    ids = new StringBuffer(30); 
    for (Iterator<Jasen>  i=jasenet.iterator(); i.hasNext(); ) {
    Jasen jasen = i.next(); 
    ids.append(" "+jasen.getJasenID()); 
    }
    assertEquals("From: Jasenet line: 276", tulos, ids.toString()); 
    Iterator<Jasen>  i=jasenet.iterator(); 
    assertEquals("From: Jasenet line: 279", true, i.next() == jouko1); 
    assertEquals("From: Jasenet line: 280", true, i.next() == jouko2); 
    assertEquals("From: Jasenet line: 281", true, i.next() == jouko1); 
    try {
    i.next(); 
    fail("Jasenet: 283 Did not throw NoSuchElementException");
   ...
   */
  @Test
  public void testEtsi337() throws SailoException {    // Jasenet: 337
    Jasenet jasenet = new Jasenet(); 
    ...
    assertEquals("From: Jasenet line: 348", 5, loytyneet.size()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLisaa368() throws SailoException {    // Jasenet: 368
    Jasenet jasenet = new Jasenet(); 
    Jasen eka = new Jasen(); 
    Jasen toka = new Jasen(); 
    assertEquals("From: Jasenet line: 373", 0, jasenet.getLkm()); 
    jasenet.lisaa(eka); assertEquals("From: Jasenet line: 374", 1, jasenet.getLkm()); 
    jasenet.lisaa(toka); assertEquals("From: Jasenet line: 375", 2, jasenet.getLkm()); 
  } // Generated by ComTest END
}