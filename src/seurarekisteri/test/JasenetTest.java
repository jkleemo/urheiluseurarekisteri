 ...
 * @version 2021.04.20 22:03:45 // Generated by ComTest
 *
 */
...
public class JasenetTest {
  ...
  // Generated by ComTest BEGIN
  /** 
   * testJasenetIterator271 
   * @throws SailoException when error
   */
  @Test
  public void testJasenetIterator271() throws SailoException {    // Jasenet: 271
    Jasenet jasenet = new Jasenet(); 
    Jasen jouko1 = new Jasen(), jouko2 = new Jasen(); 
    ...
    assertEquals("From: Jasenet line: 289", tulos, ids.toString()); 
    ...
    assertEquals("From: Jasenet line: 300", true, i.next() == jouko1); 
    assertEquals("From: Jasenet line: 301", true, i.next() == jouko2); 
    assertEquals("From: Jasenet line: 302", true, i.next() == jouko1); 
    try {
    i.next(); 
    fail("Jasenet: 304 Did not throw NoSuchElementException");
   ...
   */
  @Test
  public void testEtsi358() throws SailoException {    // Jasenet: 358
    Jasenet jasenet = new Jasenet(); 
    ...
    assertEquals("From: Jasenet line: 369", 5, loytyneet.size()); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testLisaa389() throws SailoException {    // Jasenet: 389
    Jasenet jasenet = new Jasenet(); 
    Jasen eka = new Jasen(); 
    ...
    assertEquals("From: Jasenet line: 403", 0, jasenet.getLkm()); 
    jasenet.lisaa(eka); assertEquals("From: Jasenet line: 404", 1, jasenet.getLkm()); 
    jasenet.lisaa(toka); assertEquals("From: Jasenet line: 405", 2, jasenet.getLkm()); 
    jasenet.lisaa(kolmas); assertEquals("From: Jasenet line: 406", 3, jasenet.getLkm()); 
    jasenet.lisaa(neljas); assertEquals("From: Jasenet line: 407", 4, jasenet.getLkm()); 
    jasenet.lisaa(viides); assertEquals("From: Jasenet line: 408", 5, jasenet.getLkm()); 
    jasenet.lisaa(kuudes); assertEquals("From: Jasenet line: 409", 6, jasenet.getLkm()); 
    jasenet.lisaa(seiska); assertEquals("From: Jasenet line: 410", 7, jasenet.getLkm()); 
    jasenet.lisaa(kasi); assertEquals("From: Jasenet line: 411", 8, jasenet.getLkm()); 
    jasenet.lisaa(ysi); assertEquals("From: Jasenet line: 412", 9, jasenet.getLkm()); 
    jasenet.lisaa(kymppi); assertEquals("From: Jasenet line: 413", 10, jasenet.getLkm()); 
    jasenet.lisaa(ykstoista); assertEquals("From: Jasenet line: 414", 11, jasenet.getLkm()); 
  } // Generated by ComTest END
}